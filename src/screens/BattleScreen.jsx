...
export default function BattleScreen({ wallet, game }) {
  ...
  return (
    <div style={{ paddingBottom: 100, height: '100%', overflowY: 'auto' }}>
        ...
        <div className="battle-arena">
          ...
          <div className="glass-card battle-card">
            <img
              ...
              className="battle-card-image"
              style={{
                opacity: battleResult.won ? 0.5 : 1,
                filter: !battleResult.won
      ...
      {/* Animating */}
      {isAnimating && (
        <div className="battle-arena" style={{ paddingTop: 80 }}>
